...
export const CHARACTER_SHEET: Record<AgentRole, CharacterArchetype> = {
  ...
  ceo: {
    ...
    idleSequence: ['check_task_board', 'look_around', 'walk', 'observe', 'wander'],
  ...
  backend: {
    ...
    idleSequence: ['type', 'pause', 'type', 'look_at_monitor', 'type', 'stretch', 'wander'],
  ...
  frontend: {
    ...
    idleSequence: ['type', 'inspect_board', 'sit', 'type', 'look_at_monitor', 'stand', 'wander'],
  ...
  qa: {
    ...
    idleSequence: ['look_at_monitor', 'check_monitor', 'inspect', 'return', 'look_at_monitor', 'wander'],
  ...
  designer: {
    ...
    idleSequence: ['read', 'write', 'think', 'read', 'wander'],
  ...
  devops: {
    ...
    idleSequence: ['check_monitor', 'walk_to_server', 'inspect', 'return', 'wander'],
